...
const TRANSLATIONS = {
    zh: {
        ...
        'resources.items': '条',
        'resources.pool.main': '主池',
        'resources.pool.legacy': '旧池',
        'resources.pool.quarantine': '隔离池',
        ...
        'footer.settings': '设置', 'footer.clear': '清空资源池',
        'footer.clearConfirm': '确定要清空当前资源池吗？这会删除 main / legacy / quarantine 资源、重置发现状态和发布进度，但会保留模板记忆、发布经验、任务配置与设置。',
    ...
    en: {
        ...
        'resources.pool.main': 'Main',
        'resources.pool.legacy': 'Legacy',
        'resources.pool.quarantine': 'Quarantine',
        ...
        'footer.settings': 'Settings', 'footer.clear': 'Clear Resources',
        'footer.clearConfirm': 'Clear the current resource pool? This removes main, legacy, and quarantine resources and resets discovery/publish progress, but keeps templates, publish memory, tasks, and settings.',
        'dialog.title': 'Comment Ready',
