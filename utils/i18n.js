...
const TRANSLATIONS = {
    zh: {
        ...
        'collect.startContinuous': '开始持续发现',
        'collect.resumeContinuous': '继续持续发现',
        'collect.pauseContinuous': '暂停',
        'collect.runningStatus': '持续发现运行中',
        'collect.pausedStatus': '持续发现已暂停',
        'collect.idleStatus': '未启动持续发现',
        'collect.engineHint': '输入一个目标网站后开始持续递归分析',
        'collect.currentDomain': '当前网站',
        'collect.pendingDomains': '待递归网站',
        ...
        'collect.domainExpanded': '已下钻',
        'collect.domainCommentFound': '评论发现',
        'collect.domainFrontierEmpty': '暂无域名情报',
    ...
    en: {
        ...
        'collect.startContinuous': 'Start Continuous Discovery',
        'collect.resumeContinuous': 'Resume Continuous Discovery',
        'collect.pauseContinuous': 'Pause',
        'collect.runningStatus': 'Continuous discovery running',
        'collect.pausedStatus': 'Continuous discovery paused',
        'collect.idleStatus': 'Continuous discovery idle',
        'collect.engineHint': 'Enter a target site to start recursive continuous discovery',
        'collect.currentDomain': 'Current Site',
        'collect.pendingDomains': 'Pending Domains',
        ...
        'collect.domainExpanded': 'Expanded',
        'collect.domainCommentFound': 'From Comments',
        'collect.domainFrontierEmpty': 'No domain intel yet',
